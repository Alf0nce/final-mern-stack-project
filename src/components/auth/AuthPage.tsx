...
import { Building2, Users, PiggyBank, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-secondary/10 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-primary">Alfo Self Help Group</h1>
          <p className="text-muted-foreground mt-2">CBO Loaning & Savings Monitoring System</p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-center">
              Access your account to manage loans and savings
            </CardDescription>
          </CardHeader>
          <CardContent>
